...
public class ArmyTest extends OmniMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            //
            c = confine(voltogres(cinput.getVoltage()) - 6);
            d = voltogres(dinput.getVoltage()) + 30;
            //
            cords = xny(c, d);
            //
            powers = lumina(cords.get(0) + 1, cords.get(1), c, d);
            //180-((B4-90)-(90-B3))
            hand.setPosition((70 - ((d - 90) - (90 - c))) / 180);
            //
            ...
            telemetry.addData("new d", cords.get(2));
